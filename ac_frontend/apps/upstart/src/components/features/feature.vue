    ...
    <b-container>
      <b-row>
        <b-col md="12" class="section-header mb-5">
          <h2 class="font-weight-bold">Feature Highlights</h2>
          <p>
            Nyx provides you with the most easy-to-use healthcare toolset to
            build and customize your healthcare portal on your own.
          </p>
        </b-col>
